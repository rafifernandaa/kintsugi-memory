# Deploy Kintsugi Memory to Google Cloud Run with Vertex AI (Windows PowerShell)
$PROJECT_ID = "my-project-31-491314"
$REGION = "us-west1"
$SERVICE_NAME = "kintsugi-memory-service"

Write-Host "🌸 Deploying Kintsugi Memory Agent to Google Cloud Run (Vertex AI Mode)..." -ForegroundColor Cyan
...
Write-Host "⚡ Enabling Google Cloud Services (Vertex AI, Cloud Run, Cloud Build, Speech-to-Text, Pub/Sub, Artifact Registry)..." -ForegroundColor Cyan
gcloud services enable aiplatform.googleapis.com run.googleapis.com cloudbuild.googleapis.com speech.googleapis.com pubsub.googleapis.com artifactregistry.googleapis.com
...
Write-Host "✅ Deployment Complete! Service live on Google Cloud Run with Vertex AI." -ForegroundColor Green
